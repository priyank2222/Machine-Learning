...
from wavenet import WaveNetModel, NumberReader

BATCH_SIZE = 1          #Number of samples fed to network at a time
SAMPLE_SIZE = 1024      #length of sample fed to the network
LEARNING_RATE = 0.001  #Learning rate of the network
NUM_STEPS = 4000        #Number of times network will be trained
